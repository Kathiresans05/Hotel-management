  ...
  return (
    <div className="animate-in fade-in duration-500">
      <PageHeader 
        ...
        subtitle="Manage loyalty programs and guest history database."
        actions={
          <button 
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-background">
                    <th className="px-6 py-4 text-xs font-bold text-text-secondary uppercase">Guest</th>
                    <th className="px-6 py-4 text-xs font-bold text-text-secondary uppercase">Contact</th>
                    <th className="px-6 py-4 text-xs font-bold text-text-secondary uppercase">Status</th>
                    <th className="px-6 py-4 text-xs font-bold text-text-secondary uppercase text-center">Stays</th>
                    <th className="px-6 py-4 text-xs font-bold text-text-secondary uppercase">Last Visit</th>
            ...
            <div className="pt-14 p-6 space-y-8">
              <div>
                ...
                <div className="flex items-center mt-2">
                  <span className="px-2.5 py-1 bg-purple-soft text-purple text-[10px] font-bold rounded-full mr-2 uppercase">Platinum Member</span>
